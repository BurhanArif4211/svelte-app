...
<!-- Hero Section -->
<div class="bg-[url('/img/hero-pattren.webp')] min-h-screen bg-repeat bg-size-[800px] flex flex-col justify-center items-center relative overflow-hidden ">
  <!-- Main Content Container - Centered Single Column -->
  <div class="w-full max-w-4xl mx-auto px-4 sm:px-10 lg:px-8 py-12 md:py-20">
    <!-- Glass Card Container -->
    <div class="hero backdrop-blur-sm md:backdrop-blur-none rounded-4xl p-6 md:p-8 lg:p-12">
      <div class="text-center space-y-6 md:space-y-8">
        
        <!-- Greeting Headline -->
        <div class="headline">
          <h1 class="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl bg-linear-to-t from-[#6cffd0] to-white bg-clip-text text-transparent font-extrabold font-sans leading-tight">
            {greeting}
          </h1>
        </div>
        
        <!-- Description Lines -->
        <div class="space-y-2 text-lg sm:text-xl md:text-2xl lg:text-3xl font-light text-white">
